...
\providecommand{\algBtables}{\StrLeft{JADE}{\ntables}}
...
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{CMAES_JADE_AdapS_AdapS_AdapS_FAUC-_FAUC-_et_al/}
\providecommand{\algorithmA}{AdapSS-R1}
\providecommand{\algorithmB}{AdapSS-R2}
\providecommand{\algorithmC}{AdapSS-R3}
\providecommand{\algorithmD}{CMAES}
\providecommand{\algorithmE}{FAUC-R1}
\providecommand{\algorithmF}{FAUC-R2}
\providecommand{\algorithmG}{FAUC-R3}
\providecommand{\algorithmH}{JADE}
\providecommand{\algorithmI}{RecPM1}
\providecommand{\algorithmJ}{RecPM2}
\providecommand{\algorithmK}{RecPM3}
