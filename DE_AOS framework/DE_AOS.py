...
budget = 1e5  # maxfevals = budget x dimension ### INCREASE budget WHEN THE DATA CHAIN IS STABLE ###
...
observer_options = ObserverOptions({  # is (inherited from) a dictionary
                    ...
                    'algorithm_info': "recursive probability matching", # CHANGE/INCOMMENT THIS!
