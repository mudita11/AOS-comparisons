...
\providecommand{\algCtables}{\StrLeft{F-AUC3}{\ntables}}
\providecommand{\algBtables}{\StrLeft{CMAES}{\ntables}}
\providecommand{\algAtables}{\StrLeft{AdapSS3}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{AdapS_CMAES_F-AUC_JADE_RecPM_RecPM_RecPM_et_al/}
\providecommand{\algorithmA}{AdapSS3}
\providecommand{\algorithmB}{CMAES}
\providecommand{\algorithmC}{F-AUC3}
\providecommand{\algorithmD}{JADE}
\providecommand{\algorithmE}{RecPM1}
\providecommand{\algorithmF}{RecPM2}
\providecommand{\algorithmG}{RecPM3}
