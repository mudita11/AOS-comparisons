...
\providecommand{\algBtables}{\StrLeft{F-AUC3}{\ntables}}
...
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{AdapS_F-AUC_RecPM_RecPM_RecPM/}
\providecommand{\algorithmA}{AdapSS3}
\providecommand{\algorithmB}{F-AUC3}
\providecommand{\algorithmC}{RecPM1}
\providecommand{\algorithmD}{RecPM2}
\providecommand{\algorithmE}{RecPM3}
